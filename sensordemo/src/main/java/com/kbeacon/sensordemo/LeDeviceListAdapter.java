...
import com.kbeacon.kbeaconlib.KBAdvPackage.KBAccSensorValue;
...
import com.kbeacon.kbeaconlib.KBAdvPackage.KBAdvPacketSensor;
...
public class LeDeviceListAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup)
	{
		...
		//ibeacon data
		KBAdvPacketEddyTLM eddyTLM = (KBAdvPacketEddyTLM) device.getAdvPacketByType(KBAdvType.KBAdvTypeEddyTLM);
		KBAdvPacketSensor kSensor = (KBAdvPacketSensor) device.getAdvPacketByType(KBAdvType.KBAdvTypeSensor);
		if (eddyTLM != null)
		{
			//battery percent
