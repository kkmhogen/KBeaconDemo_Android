...
public class LeDeviceListAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup)
	{
		...
		//uid data
		KBAdvPacketEddyUID uidBeacon = (KBAdvPacketEddyUID) device.getAdvPacketByType(KBAdvType.KBAdvTypeEddyUID);
		if (uidBeacon != null)
		{
			//sid
		...
		//eddy url
		KBAdvPacketEddyURL urlBeacon = (KBAdvPacketEddyURL) device.getAdvPacketByType(KBAdvType.KBAdvTypeEddyURL);
		if (urlBeacon != null)
		{
